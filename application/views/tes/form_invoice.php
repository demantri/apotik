      ...
      <div class="x_content">
        ...
        <form action="<?php echo base_url() . 'example/add_invoice'; ?>" method="post" class="form-horizontal form-label-left" novalidate>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="item form-group">
                <input id="tgl_beli" value="<?php echo date("Y-m-d"); ?>" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1"  type="text" name="tgl_beli">
              </div>
            </div>
          </div>
          ...
          <table id="prod" class="table table-bordered">
            ...
            <tfoot>
              <tr>
                ...
                <td>
                  <input id="grandtotal" name="grandtotal" type="text" value="0" class="form-control grandtotal" readonly>
                </td>
              </tr>
            </tfoot>
          </table>
