          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class='input-group date'>
                  <input name="tgl_beli" id="tgl_beli" value="<?php echo date("Y-m-d"); ?>" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" type="text">
              </div>
            </div>
          </div>
