...
<div class="top_nav">
	<div class="nav_menu">
        ...
        <a class="dropdown-item" href="<?php echo base_url('auth/logout')?>">
					...
					<!-- <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><img src="<?php echo base_url('assets/images/img.jpg') ?>" alt="">Selamat Datang</a> -->
					<!--
