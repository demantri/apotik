...
<html lang="en">
	<head>
		...
		<link rel="shortcut icon" href="https://icons-for-free.com/iconfiles/png/512/cross+hospital+icon-1320185103418112438.png" type="image/x-icon">
		...
		<div class="container body">
			<div class="main_container">
				...
				<div class="right_col" role="main">
					...
					<a href="<?php echo base_url(); ?>"><img src="<?php echo base_url('assets/images/Pict.png') ?>" alt="..." class="img-home"></a>
						<div class="clearfix"></div>
				</div>
				</div>
				...
				<footer>
					<div class="pull-right">
						<a href="">Apotek Angel</a> <?php echo $footer; ?>
					</div>
			        <div class="clearfix"></div>
				</footer>
				<!-- /Footer Content -->
...
<script type="text/javascript">
    ...
    var counter = 1;
          ...
          $('#addRow').on( 'click', function () {
            transaksi.row.add( [
              '<select required="required" style="width:100%;" class="form-control nama_obat" id="nama_obat'+counter+'" name="nama_obat[]" data-stok="#stok'+counter+'" data-unit="#unit'+counter+'" data-harga_jual="#harga_jual'+counter+'" data-harga_beli="#harga_beli'+counter+'"><option selected="true" value="" disabled ></option><?php foreach($get_med as $gm){ ?><option value="<?php echo $gm; ?>"><?php echo $gm; ?></option><?php  }?></select>',
              ...
              '<input id="harga_beli'+counter+'" name="harga_beli[]" class="form-control harga_beli" readonly>',
        ...
        $('#prod').on('change', '.nama_obat', function() {
		  ...
		  $.ajax({
		    ...
		    success: function(data) {
		      $.each(data, function(nama_obat, stok, unit, harga_jual, harga_beli) {
